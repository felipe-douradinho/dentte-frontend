...
import { appointments } from '/@src/data/patients/about/patient-appointment-list'
...
const idSorter: VFlexTableWrapperSortFunction<Appointment> = ({ order, a, b }) => {
  if (order === 'asc') {
...
const dateFilter: VFlexTableWrapperFilterFunction<Appointment> = ({ searchTerm, row }) => {
  if (!searchTerm) {
    return true
  }
