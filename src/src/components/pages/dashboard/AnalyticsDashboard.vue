        ...
        <div class="columns is-multiline">
          ...
          <div class="column is-4">
            <div class="dashboard-tile">
              <div class="tile-head">
                <h3 class="dark-inverted">Transações</h3>
          ...
          <div class="column is-4">
            <div class="dashboard-tile">
              <div class="tile-head">
                <h3 class="dark-inverted">Pacientes</h3>
          ...
          <div class="column is-4">
            <div class="dashboard-tile">
              <div class="tile-head">
                <h3 class="dark-inverted">Indicações</h3>
          ...
          <div class="column is-8">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">Faturamento</h3>
              </div>
              <div class="revenue-stats">
                <div class="revenue-stat">
                  <span>Este Mês</span>
                  <span class="current">R$ 75.648,43</span>
                </div>
                <div class="revenue-stat">
                  <span>Mês Passado</span>
                  <span class="dark-inverted">R$ 91.512,18</span>
                </div>
              </div>
              <ApexChart
                id="revenue-chart"
          ...
          <div class="column is-4">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">Objetivos</h3>
              </div>
          ...
          <div class="column is-4">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">Vendas</h3>
              </div>
          ...
          <div class="column is-8">
            <div class="dashboard-card">
              <div class="card-head">
                <h3 class="dark-inverted">Lucro</h3>
              </div>
              <ApexChart
                id="profit-chart"
